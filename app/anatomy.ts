...
export const SYSTEMS: {id:SystemId;name:string;color:string;description:string}[] = [
 ...
 {id:'nervous',name:'Nervous system',color:'#d88ca0',description:'The brain, spinal cord, and peripheral nerves carry and process signals. They support sensation, movement, coordination, and automatic regulation of body functions.'},

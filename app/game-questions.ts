...
const POOLS: Record<Difficulty, string[]> = {
  ...
  college: [
    ...
    'corpus callosum','optic chiasm','amygdala','midbrain',
    'hyoid bone','sphenoid bone','ethmoid','occipital bone',
    'cricoid cartilage','thyroid cartilage','epiglottis','septal nasal cartilage',
    'pineal body','pituitary gland','right adrenal gland','left adrenal gland',
    'caudate lobe of liver','pancreatic duct','cystic duct','ileocecal junction',
    'prostate','left epididymis','right seminal vesicle','corpus spongiosum of penis',
    'left lacrimal gland','right submandibular gland','left nasolacrimal duct','right lacrimal sac',
    'right sternocleidomastoid','left scalenus anterior','diaphragm','linea alba',
    'celiac trunk','splenic artery','renal artery','common iliac artery',
    'azygos vein','superior vena cava','pulmonary trunk','internal carotid artery',
    'left main bronchus','right main bronchus','trachea','inferior nasal concha',
  ],
  medical: [
    'anterior commissure','mammillary body','cerebral aqueduct','habenula',
    'lamina terminalis','stria terminalis','tuber cinereum','interpeduncular fossa',
    'tentorium cerebelli','fourth ventricle','optic chiasm','peduncle of midbrain',
    'left ciliary ganglion','right ophthalmic nerve','left nasociliary nerve','right trochlear nerve',
    'left frontal nerve','right lacrimal nerve','left optic nerve','superior branch of right oculomotor nerve',
    'arytenoid cartilage','corniculate cartilage','cuneiform cartilage','major alar cartilage',
    'left palatopharyngeus','right stylopharyngeus','left salpingopharyngeus','thyroid cartilage',
    'caudate lobe of liver','common hepatic duct','cystic duct','taenia libera',
    'mesoappendix','transverse mesocolon','distal part of ileum','pancreatic duct tree',
    'pineal body','left adrenal gland','right lobe of thymus','corpus cavernosum of penis',
    'left deferent duct','glans penis','left epididymis','right seminal vesicle',
    'left superior rectus','right digastric','left platysma','transverse arytenoid',
    'right gemellus superior','left obturator internus','right quadratus femoris','spinalis',
    'hyoid bone','sphenoid bone','vomer','median cricothyroid ligament',
    'left vocal ligament','right stylohyoid ligament','long plantar ligament','check ligament of left lateral rectus',
    'azygos vein','basilar artery','anterior communicating artery','cerebral arterial circle',
    'popliteal artery','left renal artery','right coronary artery','inferior vena cava',
    'left anterior basal segmental bronchial tree','right superior segmental bronchial tree','epiglottis','cricoid cartilage',
  ],
};
